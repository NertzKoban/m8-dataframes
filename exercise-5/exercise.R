...
org.largest.grant <- grants$organization[(grants$total_amount) == max(grants$total_amount)]
largest.recipient <- org[spending == largest.grant]

# Which organization received the smallest grant?
org.smallest.grant <- grants$organization[(grants$total_amount) == min(grants$total_amount)]
smallest.recipient <- org[spending == smallest.grant]

# How many grants were awarded in 2010?
num.grants.2010 <- length(spending[grants$start_year == 2010])
